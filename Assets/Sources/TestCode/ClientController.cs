...
public class ClientController : MonoBehaviour {
	...
	void client_DataItemsChanged(object sender, EventArgs e)
	{
		...
		//Lanzar evento o metodo
		tableController.assignValue();
	...
	void client_DataItemChanged(object sender, DataItemChangedEventArgs e)
	{
		...
		//Debug.Log (">>>key: "+e.DataItem.Name);
		//Debug.Log (">>>value: "+e.DataItem.CurrentSample);

		string valuesKey = e.DataItem.Name.ToString();
		string valuesValue = e.DataItem.CurrentSample.ToString ();

		if (Session_App.values.ContainsKey (valuesKey)) {
			Session_App.values[valuesKey] = valuesValue;
			//Debug.Log ("DataItem Replaced");
		} else {
			Session_App.values.Add (valuesKey, valuesValue);
			//Debug.Log (valuesKey+"::"+valuesValue);
			//Debug.Log ("DataItem Added");
		}
